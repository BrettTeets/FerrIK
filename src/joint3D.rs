...
#[allow(dead_code)]
pub const MIN_CONSTRAINT_ANGLE_DEGS: cgmath::Rad<f32> = cgmath::Deg(0.0).into(); //fully constrained
pub const MAX_CONSTRAINT_ANGLE_DEGS: cgmath::Rad<f32> = cgmath::Deg(180.0).into(); //unconstrained.

#[derive(Clone)]
pub struct Joint3D{
    pub joint_type: joint::JointType,
    pub rotor_constraint: cgmath::Rad<f32>,
    pub hinge_clockwise_constraint: cgmath::Rad<f32>,
    pub hinge_anticlockwise_constraint: cgmath::Rad<f32>,
    //The unit vector axis about which a hinged joint may rotate.
	pub rotation_axis_uv: cgmath::Vector3<f32>,
	...
	pub reference_axis_uv: cgmath::Vector3<f32>,
}
...
impl Joint3D{
    ...
    pub fn set_as_ball_joint(&mut self, constraint_degrees: cgmath::Rad<f32>){
    ...
    pub fn set_as_global_hing(&mut self,  rotation_axis: cgmath::Vector3<f32>, reference_axis: cgmath::Vector3<f32>, clockwise_constraint: cgmath::Rad<f32>, anticlockwise_constraint: cgmath::Rad<f32>){
        self.set_hinge(joint::JointType::GlobalHinge, rotation_axis, reference_axis, clockwise_constraint, anticlockwise_constraint);
    }

    pub fn set_as_local_hing(&mut self,  rotation_axis: cgmath::Vector3<f32>, reference_axis: cgmath::Vector3<f32>, clockwise_constraint: cgmath::Rad<f32>, anticlockwise_constraint: cgmath::Rad<f32>){
    ...
    pub fn set_hinge(&mut self, joint_type: joint::JointType, rotation_axis: cgmath::Vector3<f32>, reference_axis: cgmath::Vector3<f32>,
        clockwise_constraint: cgmath::Rad<f32>,  anticlockwise_constraint: cgmath::Rad<f32>){
    ...
    pub fn get_hinge_clockwise_and_anticlockwise_constraints(&self) -> (cgmath::Rad<f32>, cgmath::Rad<f32>){
    ...
    pub fn get_ball_constraint(&self) -> cgmath::Rad<f32>{
        //check if this is a ball joint,

        return self.rotor_constraint;
    }

    fn validateConstraintAngleDegs(angleDegs: cgmath::Rad<f32>)
	{
